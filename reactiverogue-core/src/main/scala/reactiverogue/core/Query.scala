...
/**
  ...
  */
case class Query[M, R, +State](meta: M,
  ...
  private def addClauseOpt[V, F](opt: Option[V])(clause: (M, V) => QueryClause[F],
  ...
  def raw(f: ListBuffer[(String, BSONValue)] => Unit): Query[M, R, State] = {
  ...
  def or[S2](
      subqueries: (Query[
                     M,
                     R,
                     Ordered with Selected with Limited with Skipped with HasNoOrClause] => Query[
                     M,
                     R,
                     _])*)(implicit ev: AddOrClause[State, S2]): Query[M, R, S2] = {
    val queryBuilder =
  ...
  def noop()(implicit ev1: Required[State, Unselected with Unlimited with Unskipped],
  ...
  def select[F1, F2, F3, S2](f1: M => SelectField[F1, M],
  ...
  def select[F1, F2, F3, F4, S2](f1: M => SelectField[F1, M],
                                 f2: M => SelectField[F2, M],
                                 f3: M => SelectField[F3, M],
  ...
  def select[F1, F2, F3, F4, F5, S2](f1: M => SelectField[F1, M],
                                     f2: M => SelectField[F2, M],
                                     f3: M => SelectField[F3, M],
                                     f4: M => SelectField[F4, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, S2](f1: M => SelectField[F1, M],
                                         f2: M => SelectField[F2, M],
                                         f3: M => SelectField[F3, M],
                                         f4: M => SelectField[F4, M],
                                         f5: M => SelectField[F5, M],
    ...
    selectCase(f1,
               ...
               f5,
               f6,
               (f1: F1, f2: F2, f3: F3, f4: F4, f5: F5, f6: F6) => (f1, f2, f3, f4, f5, f6))
  }

  def select[F1, F2, F3, F4, F5, F6, F7, S2](f1: M => SelectField[F1, M],
                                             f2: M => SelectField[F2, M],
                                             f3: M => SelectField[F3, M],
                                             f4: M => SelectField[F4, M],
                                             f5: M => SelectField[F5, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, F8, S2](f1: M => SelectField[F1, M],
                                                 f2: M => SelectField[F2, M],
                                                 f3: M => SelectField[F3, M],
                                                 f4: M => SelectField[F4, M],
                                                 f5: M => SelectField[F5, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, F8, F9, S2](f1: M => SelectField[F1, M],
                                                     f2: M => SelectField[F2, M],
                                                     f3: M => SelectField[F3, M],
                                                     f4: M => SelectField[F4, M],
                                                     f5: M => SelectField[F5, M],
  ...
  def select[F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, S2](
      ...
      f8: M => SelectField[F8, M],
      f9: M => SelectField[F9, M],
      f10: M => SelectField[F10, M])(implicit ev: AddSelect[State, S2, _])
  ...
  def selectCase[F1, F2, F3, CC, S2](
    ...
    val transformer = (xs: List[_]) =>
      create(xs(0).asInstanceOf[F1], xs(1).asInstanceOf[F2], xs(2).asInstanceOf[F3])
    this.copy(select = Some(MongoSelect(fields, transformer)))
  }
  ...
  def selectCase[F1, F2, F3, F4, F5, CC, S2](f1: M => SelectField[F1, M],
                                             f2: M => SelectField[F2, M],
                                             f3: M => SelectField[F3, M],
                                             f4: M => SelectField[F4, M],
                                             f5: M => SelectField[F5, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, CC, S2](f1: M => SelectField[F1, M],
                                                 f2: M => SelectField[F2, M],
                                                 f3: M => SelectField[F3, M],
                                                 f4: M => SelectField[F4, M],
                                                 f5: M => SelectField[F5, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, CC, S2](f1: M => SelectField[F1, M],
                                                     f2: M => SelectField[F2, M],
                                                     f3: M => SelectField[F3, M],
                                                     f4: M => SelectField[F4, M],
                                                     f5: M => SelectField[F5, M],
  ...
  def selectCase[F1, F2, F3, F4, F5, F6, F7, F8, CC, S2](
    ...
    val inst = meta
    val fields =
      List(f1(inst), f2(inst), f3(inst), f4(inst), f5(inst), f6(inst), f7(inst), f8(inst))
    val transformer = (xs: List[_]) =>
      create(
        xs(0).asInstanceOf[F1],
        xs(1).asInstanceOf[F2],
...
case class ModifyQuery[M, +State](query: Query[M, _, State], mod: MongoModify) {
  ...
  def asBSONDocument = (this.query.asBSONDocument, MongoBuilder.buildModify(this.mod))
}
...
case class FindAndModifyQuery[M, R](query: Query[M, R, _], mod: MongoModify) {
  ...
  override def toString: String =
    MongoBuilder.buildFindAndModifyString(query.collectionName,
                                          this,
                                          returnNew = false,
                                          upsert = false,
                                          remove = false)

...
trait Rogue {
  ...
  implicit def robjectIdFieldToObjectIdQueryField[M](f: RField[BSONObjectID, M]): ObjectIdQueryField[M] = new ObjectIdQueryField[M](f)
  ...
  implicit def rdbobjectFieldToQueryField[M](f: RField[BSONDocument, M]): QueryField[BSONDocument, M] = new QueryField(f)
  ...
  implicit def rlistFieldToListQueryField[M, F: BSONSerializable](f: RField[List[F], M]): ListQueryField[F, M] = new ListQueryField[F, M](f)
  implicit def rseqFieldToSeqQueryField[M, F: BSONSerializable](f: RField[Seq[F], M]): SeqQueryField[F, M] = new SeqQueryField[F, M](f)
  ...
  implicit def objectidRFieldToModifyField[M](f: RField[BSONObjectID, M]): ModifyField[BSONObjectID, M] = new ModifyField(f)
  ...
  implicit def rlistFieldToListModifyField[M, F: BSONSerializable](f: RField[List[F], M]): ListModifyField[F, M] =
    new ListModifyField[F, M](f)

  implicit def rSeqFieldToSeqModifyField[M, F: BSONSerializable](f: RField[Seq[F], M]): SeqModifyField[F, M] =
    new SeqModifyField[F, M](f)

  implicit def rmapFieldToMapModifyField[M, F: BSONSerializable](f: RField[Map[String, F], M]): MapModifyField[F, M] =

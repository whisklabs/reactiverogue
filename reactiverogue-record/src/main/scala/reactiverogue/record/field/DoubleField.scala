...
class DoubleField[OwnerType <: BsonRecord[OwnerType]](rec: OwnerType)
    extends DirectBsonField[Double] with Field[Double, OwnerType] with MandatoryTypedField[Double] {
...
class OptionalDoubleField[OwnerType <: BsonRecord[OwnerType]](rec: OwnerType)
    extends DirectBsonField[Double] with Field[Double, OwnerType] with OptionalTypedField[Double] {

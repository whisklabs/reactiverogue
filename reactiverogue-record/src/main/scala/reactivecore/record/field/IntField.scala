...
class IntField[OwnerType <: BsonRecord[OwnerType]](rec: OwnerType)
    extends DirectBsonField[Int] with Field[Int, OwnerType] with MandatoryTypedField[Int] {
...
class OptionalIntField[OwnerType <: BsonRecord[OwnerType]](rec: OwnerType)
    extends DirectBsonField[Int] with Field[Int, OwnerType] with OptionalTypedField[Int] {
